...
coeffs=np.array([[ pi, 0, 0],
                 [pi, pi*1.25, 0],
                 [pi, .75*pi, 0]])
coeffs_disj=np.copy(coeffs)

coeffs_all=np.copy(coeffs)
...
#seq_to_cf =[2, 6, 4, 3] #[2, 1, 3, 4, 5, 6, 7]  # 0: system, 1-6: targets | 7 cfs total
#z_cfs = [1.1,.4,.4,.4] # Altitudes: system at 1 m, targets at 0.5 m
